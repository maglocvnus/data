...
`Event sourcing` is a data architectural design pattern, where [event logs](event-logs.md) are used as the ultimate source of truth from which current state is derived.
